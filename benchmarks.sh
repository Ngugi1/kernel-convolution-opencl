...
python main_local.py ./input/img$2.jpg kernel_uchar4_local_mem $work_group_size $kernel_dim 0 >> ./output_cpu_img/output_cpu_local_mem_img_$2.csv

python main_local.py $img_path kernel_uchar4_local_mem 8 $kernel_dim 0 >> ./output_cpu_wgsize/output_cpu_local_mem_wgs_$8.csv
python main_local.py $img_path kernel_uchar4_local_mem 32 $kernel_dim 0 >> ./output_cpu_wgsize/output_cpu_local_mem_wgs_$32.csv
