...
do
    ...
    PYOPENCL_COMPILER_OUTPUT=1 python main.py $img_path kernel_naive $work_group_size $k_dim 0 >> ./output_cpu_k_dim/output_cpu_naive_kernel_dim_$k_dim.csv
    echo "Kernel Naive >> - Kernel-Dim-GPU-"$k_dim
    PYOPENCL_COMPILER_OUTPUT=1 python main.py $img_path kernel_naive $work_group_size $k_dim 1 >> ./output_gpu_k_dim/output_gpu_naive_kernel_dim_$k_dim.csv


    echo "Kernel Uchar4 >> Kernel-Dim-CPU-"$k_dim
    PYOPENCL_COMPILER_OUTPUT=1 python main.py $img_path kernel_uchar4 $work_group_size $k_dim 0 >> ./output_cpu_k_dim/output_cpu_uchar4_kernel_dim_$k_dim.csv
    echo "Kernel Uchar4 >> Kernel-Dim-GPU-"$k_dim
    PYOPENCL_COMPILER_OUTPUT=1 python main.py $img_path kernel_uchar4 $work_group_size $k_dim 1 >> ./output_gpu_k_dim/output_gpu_uchar4_kernel_dim_$k_dim.csv

    echo "Kernel Local Memory >> Kernel-Dim-CPU-"$k_dim
    PYOPENCL_COMPILER_OUTPUT=1 python main_local.py $img_path kernel_uchar4_local_mem $work_group_size $k_dim 0 >> ./output_cpu_k_dim/output_cpu_local_mem_kernel_dim_$k_dim.csv
    echo "Kernel Local Memory >> Kernel-Dim-GPU-"$k_dim
    PYOPENCL_COMPILER_OUTPUT=1 python main_local.py $img_path kernel_uchar4_local_mem $work_group_size $k_dim 1 >> ./output_gpu_k_dim/output_gpu_local_mem_kernel_dim_$k_dim.csv
...
do
    ...
    PYOPENCL_COMPILER_OUTPUT=1 python main.py ./input/img$img.jpg kernel_naive $work_group_size $kernel_dim 0 >> ./output_cpu_img/output_cpu_naive_img_$img.csv
    echo "Kernel Naive >> Image - GPU"$img
    PYOPENCL_COMPILER_OUTPUT=1 python main.py ./input/img$img.jpg kernel_naive $work_group_size $kernel_dim 1 >> ./output_gpu_img/output_gpu_naive_img_$img.csv

    echo "Kernel Uchar4 >> Image - CPU "$img
    PYOPENCL_COMPILER_OUTPUT=1 python main.py ./input/img$img.jpg kernel_uchar4 $work_group_size $kernel_dim  0 >> ./output_cpu_img/output_cpu_uchar4_img_$img.csv
    echo "Kernel Uchar4 >> Image - GPU"$img
    PYOPENCL_COMPILER_OUTPUT=1 python main.py ./input/img$img.jpg kernel_uchar4 $work_group_size $kernel_dim  1 >> ./output_gpu_img/output_gpu_uchar4_img_$img.csv

    echo "Kernel Local Memory >> Image - CPU "$img
    PYOPENCL_COMPILER_OUTPUT=1 python main_local.py ./input/img$img.jpg kernel_uchar4_local_mem $work_group_size $kernel_dim 0 >> ./output_cpu_img/output_cpu_local_mem_img_$img.csv
